...
<head>
  ...
  <title>Business Essential Course Details</title>
</head>
<body>
    <h4><center>Learn Panda</center></h4>
    <p>Learn Panda is where smart and enthusiastic Bangladeshi people, who are lifelong learners, come to get the skills they need and to transform their lives as they want. We are a community of enthusiastic learners united in a shared objective of life transformation through self-learning. Learn Panda is Bangladesh’s leading educational platform for superior online courses, professional training and corporate eLearning services that help you develop useful skills and accomplish more in life. Our online courses and career-track programs are designed in collaboration with the best of industry experts and organizations in Bangladesh.</p>

    <h2><center>Our Mission</center></h2>
    <p>Our mission is to even up education through the offering of high-quality learning opportunities that are accessible, flexible, and affordable. Virtually anyone anywhere in Bangladesh with an internet connection and a determination of self-learning can come to Bohubrihi, master an array of skills, and start working to pursue his dreams.</p>
